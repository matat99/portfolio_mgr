...
from data_retrieval import weekly_performance, calculate_overall_performance, get_eur_exchange_rates, calculate_position_values_with_currency_adjustment, yearly_performance
...
if __name__ == "__main__":
    ...
    yearly = yearly_performance(transaction_data, downloaded_data, current_tickers)
